...
2. [Passo 1: Configurando o JsonServer](#passo-1-configurando-o-jsonserver)
   - [Criando o produtos.js](#criando-o-produtosjs)
   - [Executando o JsonServer](#executando-o-jsonserver)
3. [Passo 2: Configurando o Flutter](#passo-2-configurando-o-flutter)
   - [Estrutura do Projeto](#estrutura-do-projeto)
   - [Criando o Modelo Produto](#criando-o-modelo-produto)
4. [Passo 3: Criando o Serviço HTTP para GET e POST](#passo-3-criando-o-serviço-http-para-get-e-post)
5. [Passo 4: Interface no Flutter com Formulário para Adicionar Produtos](#passo-4-interface-no-flutter-com-formulário-para-adicionar-produtos)
6. [Passo 5: Adicionar o pacote http no arquivo pubspec.yaml](#passo-5-adicionar-o-pacote-http-no-arquivo-pubspecyaml)
...
Crie um arquivo chamado `produtos.js` que será usado pelo JsonServer para simular a API REST.
...
Use o comando abaixo para iniciar o servidor na porta 3000:
```
json-server --watch produtos.js --port 3000
```
